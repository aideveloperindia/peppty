      ...
      <div className="mx-auto max-w-7xl px-6 py-16 lg:px-8">
        <div className="grid gap-12 md:grid-cols-4">
          <div className="md:col-span-2">
            <img src="/peppty-logo.png" alt="Peppty logo" className="h-8 w-auto" />
          ...
          <div>
            ...
            <ul className="mt-4 space-y-3">
              ...
              <li><Link href="/legal/terms" className="text-base text-slate-600 transition-colors duration-[150ms] hover:text-primary">Terms of Use</Link></li>
        ...
        <div className="mt-16 flex flex-col gap-4 border-t border-slate-100 pt-8 text-sm text-slate-500 md:flex-row md:items-center md:justify-between">
          ...
          <div className="flex gap-6">
            <Link href="/contact" className="transition-colors duration-[150ms] hover:text-primary">Contact</Link>
          </div>
        </div>
      </div>
    </footer>
