  ...
  return (
    <>
      ...
      <main className="pt-28">
        ...
        <FeatureBlock eyebrow="Engagement" title="Always-on feedback" copy="Enable 24×7×365 engagement and sentiment analysis across decentralized audiences." />
        <FeatureBlock align="right" eyebrow="Simplicity" title="Lightweight & trusted" copy="Short, structured interactions that are easy to complete and verify." />
      </main>
      <Footer />
    </>
  );
